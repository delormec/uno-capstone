...
import org.habitatomaha.HOST.Activity.SubmitFormActivity;
import org.junit.Test;


public class SubmitFormActivityTest extends ActivityUnitTestCase {
	

	View answerField; // The Text field where our answer is input
	SubmitFormActivity mActivity; // The actual activity
	 ...
	 * 
	 */
	public SubmitFormActivityTest() {
	    super(SubmitFormActivity.class);
	  } 
	...
	@Override
	  protected void setUp() throws Exception {
		  ...
		  //ourIntent.
		  //ourIntent.
		 // mActivity = (SubmitFormActivity) startActivity(ourIntent, null, null);// create our new activity
