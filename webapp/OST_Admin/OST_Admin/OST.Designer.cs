...
namespace OST_Admin
{
    ...
    /// </summary>
    public partial class OSTDBEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new OSTDBEntities object using the connection string found in the 'OSTDBEntities' section of the application configuration file.
        /// </summary>
        public OSTDBEntities() : base("name=OSTDBEntities", "OSTDBEntities")
        {
        ...
        /// <summary>
        /// Initialize a new OSTDBEntities object.
        /// </summary>
        public OSTDBEntities(string connectionString) : base(connectionString, "OSTDBEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new OSTDBEntities object.
        /// </summary>
        public OSTDBEntities(EntityConnection connection) : base(connection, "OSTDBEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
